...
// [SECTION] MISC HELPER/UTILITIES (glm, String, Format, Hash, File functions)
...
/*
 ...
 - You can later customize the imconfig.h file to tweak some compile-time behavior, such as integrating imgui types with your own glm types.
